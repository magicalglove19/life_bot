...
# ----------------------------------------------------------------------
# 파라미터 (패턴 A는 지수이평 EMA, 패턴 B는 단순이평 MA)
#
# 예전 주석은 "로컬 screener.py와 동일하게 유지할 것"이었으나 사실이 아니다.
# 2026 유목민 8일선및 정배열/screener.py 는 기준봉·눌림목 4티어·224일선 돌파를
# 보는 별개 프로그램이고, 패턴 A/B 로직 자체가 없다. 두 스크리너가 서로 다른
# 종목을 뱉는 것은 정상이며, 이평 종류를 서로 맞출 이유도 없다.
# ----------------------------------------------------------------------
